...
export interface CronStaticMessageSpec {
  message?: string;
  images?: string[];
  targets?: string[];
}
...
export interface CronPayload {
  ...
  staticMessage?: CronStaticMessageSpec;
}
    ...
    async (params: {
      ...
      try {
        const payload = {
          ...
          staticMessage: params.staticMessage,
          agentId: params.agentId,
          deliver: params.deliver,
          deliverChannel: params.deliverChannel || params.channel,
          deliverTo: params.to,
        };
        await ws.call(Methods.CRON_CREATE, payload);
        await invalidate();
